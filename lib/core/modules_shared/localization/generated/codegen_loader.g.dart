...
class CodegenLoader extends AssetLoader {
  ...
  static const Map<String, dynamic> _pl = {
    ...
    "failure": {
      ...
      "format": {"error": "Odebrano nieprawidłowe dane."},
      "network": {
  ...
  static const Map<String, dynamic> _uk = {
    ...
    "failure": {
      "firebase": {
        ...
        "invalid_credential":
            "Некоректні облікові дані. Будь ласка, перевірте правильність введення та спробуйте ще раз",
        "generic": "Сталася помилка Firebase.",
      },
      "format": {"error": "Отримано некоректні дані."},
      "network": {
        "no_connection": "Немає підключення до Інтернету.",
        "timeout": "Час очікування минув. Спробуйте ще раз.",
      },
      "auth": {"unauthorized": "Сесія закінчилась. Увійдіть знову."},
      "plugin": {"missing": "Відсутній плагін. Зверніться до підтримки."},
  ...
  static const Map<String, dynamic> _en = {
    "app": {"title": "Firebase with Riverpod"},
    "languages": {
    ...
    "failure": {
      ...
      "format": {"error": "Invalid data format received."},
      "network": {
      ...
      "plugin": {"missing": "Missing plugin detected. Please contact support."},
